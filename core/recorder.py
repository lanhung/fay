...
from ai_module.nlp_lingju import Lingju
...
class Recorder:
    ...
    def __init__(self, fay):
        ...
        if cfg.config['source']['wake_word_enabled']:
            self.timer = threading.Timer(300, self.reset_wakeup_status)  # 60秒后执行reset_wakeup_status方法
